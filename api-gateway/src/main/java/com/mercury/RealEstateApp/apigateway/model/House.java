package com.mercury.RealEstateApp.apigateway.model;
...
public class House {
	...
	//
	public void setHuName(String name) {
		this.huName =name;
	...
	public void setType(Integer type) {
		...
		if (Objects.equal(type, 1)) {
			...
			this.priceStr = "$" + this.price + "Per Month";
		}
	}
	...
	// add the community and city to the address attribute
	...
	public String toString() {
		return "House [id=" + id + ", type=" + type + ", price=" + price + ", name=" + name + ", images=" + images
				...
				+ communityId + ", address=" + address + ", firstImg=" + firstImg + ", floorPlanList=" + floorPlanList
				+ ", featureList=" + featureList + ", houseFiles=" + houseFiles + ", floorPlanFiles=" + floorPlanFiles
				+ ", priceStr=" + priceStr + ", typeStr=" + typeStr + ", userId=" + userId + ", bookmarked="
