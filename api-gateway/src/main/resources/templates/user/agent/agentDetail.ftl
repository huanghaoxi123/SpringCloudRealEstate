                ...
                <div class="col-md-9 col-sm-9">
                    <section id="agent-detail">
                        ...
                        <section id="agent-properties">
                            <header><h3>Property Collection</h3></header>
                    ...
                    <section id="sidebar">
                         <aside id="edit-search">
                            ...
                            <form role="form" id="searchForm" class="form-search" method="post" action="/house/list">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="search-box-property-id" value="${(vo.name)!}" name="name" placeholder="Search by community">
                                </div>
                                <div class="form-group">
                                    <select name="type">
