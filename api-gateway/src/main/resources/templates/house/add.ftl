                        ...
                        <div class="col-md-9 col-sm-9">
                            <section id="submit-form">
                                <section id="basic-information">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="submit-title">Property Information Tag</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="submit-price" name="price" pattern="\d*" required>
                                    ...
                                    <div class="form-group">
                                        <label for="submit-description">Property Description</label>
                                    ...
                                    <div class="row">
                                        <div class="block clearfix">
                                            <div class="col-md-6 col-sm-6">
                                                <section id="summary">
                                                    <header><h2>Property Information</h2></header>
                                                    <div class="form-group">
                                                        <label for="submit-location">State</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="submit-location">Choose Community</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label for="submit-Baths">Bathrooms</label>
